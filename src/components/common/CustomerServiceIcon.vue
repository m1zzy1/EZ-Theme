  ...
  setup() {
    ...
    const positionStyle = computed(() => {
      ...
      if (isMobile.value) {
        ...
        const desktopPosition = CUSTOMER_SERVICE_CONFIG.iconPosition.desktop || {};

        const useRight = !!desktopPosition.right;

        return {

          left: useRight ? 'auto' : desktopPosition.left,

          right: useRight ? desktopPosition.right : 'auto',
